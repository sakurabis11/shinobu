...
𝗠𝗲𝘀𝘀𝗮𝗴𝗲 <b>: {}</b>"""
    ...
    POSTSENDER_TXT = """Hᴇʟʟᴏ {}

Gᴇᴛ ᴄʜᴀɴɴᴇʟ ID ʙʏ sᴇɴᴅɪɴɢ /get_id ɪɴ ᴛʜᴇ ᴄʜᴀɴɴᴇʟ ᴀɴᴅ ᴀᴅᴅ ᴛʜᴇ ʙᴏᴛ ᴀs ᴀᴅᴍɪɴ.
Rᴇᴘʟʏ ᴛᴏ ᴀ ᴘᴏsᴛ ᴡɪᴛʜ /send <ᴄʜᴀɴɴᴇʟ ID> ɪɴ ᴛʜᴇ ʙᴏᴛ ᴘᴍ.
Bᴏᴛ ᴡɪʟʟ sᴇɴᴅ ᴛʜᴇ ᴘᴏsᴛ ᴛᴏ ᴛʜᴇ sᴘᴇᴄɪғɪᴇᴅ ᴄʜᴀɴɴᴇʟ(ᴡɪᴛʜᴏᴜᴛ ɪɴʟɪɴᴇ ᴛᴀɢ ᴀɴᴅ ғᴏʀᴡᴀʀᴅᴇᴅ ᴛᴀɢ).
"""
